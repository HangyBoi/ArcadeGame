...
namespace GXPEngine
{
	...
	public class AnimationSprite : Sprite
	{
		...
		protected override void setUVs() {
            ...
            {
                case 0:
                    _uvs = new float[8] { frameLeft, frameTop, frameRight, frameTop, frameRight, frameBottom, frameLeft, frameBottom, };
                    break;
                case 1:
                    _uvs = new float[8] { frameLeft, frameBottom, frameLeft, frameTop, frameRight, frameTop, frameRight, frameBottom, };
                    break;
                case 2:
                    _uvs = new float[8] { frameRight, frameBottom, frameLeft, frameBottom, frameLeft, frameTop, frameRight, frameTop, };
                    break;
                case 3:
                    _uvs = new float[8] { frameRight, frameTop, frameRight, frameBottom, frameLeft, frameBottom, frameLeft, frameTop, };
                    break;
            }
		}
