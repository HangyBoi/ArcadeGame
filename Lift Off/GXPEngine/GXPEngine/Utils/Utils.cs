...
namespace GXPEngine
{
	...
	public static class Utils
	{
        ...
        public static Vector2 Random(Vector2 value, Vector2 delta)
        {
			return new Vector2(Random(value.x - delta.x, value.x + delta.x),Random(value.y - delta.y, value.y + delta.y));
        }
