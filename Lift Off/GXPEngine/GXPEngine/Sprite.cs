...
namespace GXPEngine
{
	...
	public class Sprite : GameObject
	{
		...
		protected virtual void setUVs() {
			...
			switch (_rot)
			{
				case 0:
					...
					break;
				case 1:
                    _uvs = new float[8] { left, bottom, left, top, right, top, right, bottom, };
                    break;
                case 2:
                    _uvs = new float[8] { right, bottom, left, bottom, left, top, right, top, };
                    break;
                case 3:
                    _uvs = new float[8] { right, top, right, bottom, left, bottom, left, top, };
                    break;
            }
		}
		...
		internal float[] GetArea() {
			return new float[12] {
				_bounds.left, _bounds.top, z,
				_bounds.right, _bounds.top, z,
				_bounds.right, _bounds.bottom, z,
				_bounds.left, _bounds.bottom, z
			};
		}
        ...
        /// </summary>
        /// <param name='rot'>
        /// 0 - straight, 1 - 90 deg clockwise, 2 - 180 deg clockwise, 3 - 90 deg counterclockwise.
        /// </param>
