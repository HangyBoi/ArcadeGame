...
namespace GXPEngine.OpenGL {
	...
	public class GL
	{
        ...
        public static extern void ColorMask(bool r, bool g, bool b, bool a);
        [DllImport("opengl32.dll", EntryPoint = "glDepthFunc")]
        public static extern void DepthFunc(int cap);
		...
		public static extern uint CreateShader(int type);
        ...
        public static extern void ShaderSource(uint shader, int size, char[] source, int[] length);
